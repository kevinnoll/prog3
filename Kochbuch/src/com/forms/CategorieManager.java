			...
			public void actionPerformed(ActionEvent e) {
				if (JOptionPane.showConfirmDialog(scrollPane, "Möchten Sie die Kategorie wirklich löschen ?", "Bitte bestätigen", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) { //$NON-NLS-1$ //$NON-NLS-2$
					...
					if (saveDelete) {
						...
						JOptionPane.showMessageDialog(null, "Die Kategorie kann nicht gelöscht werden, da sie noch in einem Rezept verwendet wird.", "Löschen nicht möglich", JOptionPane.WARNING_MESSAGE);
					}	
